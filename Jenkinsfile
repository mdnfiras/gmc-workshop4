    ...
    stages {
        ...
        stage ('Front end image build') {
            steps {
                ...
                sh "docker build --tag ${env.DOCKER_USER}/gmc-angular-front:latest --file ./angular-app/Dockerfile ./angular-app/"
        ...
        stage ('Back end image build') {
            steps {
                ...
                sh "docker build --tag ${env.DOCKER_USER}/gmc-express-back:latest --file ./express-server/Dockerfile ./express-server/"
